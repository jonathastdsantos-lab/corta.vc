...
const STR = {
  pt: {
    ...
    greeting: (name) => `Bom te ver, ${name} ✦`, greeting_sub: 'Cole um link ou suba um vídeo — a IA acha os melhores momentos.',
    ...
    proc_title: 'Analisando seu vídeo', proc_sub: 'Isso leva alguns minutos. A IA está caçando seus melhores momentos.', dl: 'Baixar',
  ...
  en: {
    ...
    greeting: (name) => `Good to see you, ${name} ✦`, greeting_sub: 'Paste a link or upload a video — AI finds the best moments.',
    ...
    proc_title: 'Analyzing your video', proc_sub: 'This takes a few minutes. AI is hunting your best moments.', dl: 'Download',
